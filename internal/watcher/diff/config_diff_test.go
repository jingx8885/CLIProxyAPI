...
func TestBuildConfigChangeDetails(t *testing.T) {
	oldCfg := &config.Config{
		...
		RemoteManagement: config.RemoteManagement{
			...
			DisableControlPanelDownload: false,
	...
	newCfg := &config.Config{
		...
		RemoteManagement: config.RemoteManagement{
			...
			DisableControlPanelDownload: true,
	...
	expectContains(t, details, "remote-management.disable-control-panel-download: false -> true")
...
func TestBuildConfigChangeDetails_FlagsAndKeys(t *testing.T) {
	oldCfg := &config.Config{
		...
		RemoteManagement:       config.RemoteManagement{DisableControlPanel: false, DisableControlPanelDownload: false, PanelGitHubRepository: "old/repo", SecretKey: "keep"},
		SDKConfig: sdkconfig.SDKConfig{
			RequestLog:                 false,
...
func TestBuildConfigChangeDetails_AllBranches(t *testing.T) {
	...
	expectContains(t, changes, "remote-management.disable-control-panel-download: false -> true")
